...
macro(rexglue_setup_target target_name)
    ...
    if(TARGET rex::runtime_static)
        target_link_libraries(${target_name} PRIVATE rex::runtime_static)
    else()
...
# Codegen target - run 'cmake --build . --target generations_codegen'
# Uses the manifest to drive codegen for all modules (entrypoint + DLLs).
add_custom_target(generations_codegen
    COMMAND $<TARGET_FILE:rex::rexglue> codegen ${CMAKE_CURRENT_SOURCE_DIR}/generations_manifest.toml
    WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
    COMMENT "Generating recompiled code for generations"
    VERBATIM
)

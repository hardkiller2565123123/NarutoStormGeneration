...
class ReXApp : public ui::WindowedApp, public ui::WindowListener, public ui::WindowInputListener {
 ...
 protected:
  ...
  /// Allows player builds to opt out of every host-side ImGui overlay and its
  /// keyboard bindings while retaining the native game renderer.
  virtual bool EnableHostOverlays() const { return true; }

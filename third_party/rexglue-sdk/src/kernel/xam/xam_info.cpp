...
u32 XamGetSystemVersion_entry() {
  // Generations gates the session-details path behind the XDK version. A
  // version below 0x200CE900 makes it skip the valid XGI implementation and
  // then dereference an uninitialized member record while creating a
  // system-link lobby.
  return 0x200CE900;
}

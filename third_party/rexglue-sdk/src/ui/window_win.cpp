...
bool Win32Window::OpenImpl() {
  ...
  wchar_t debug_hidden[2]{};
  const bool hide_debug_window =
      GetEnvironmentVariableW(L"STORM_RECOMP_DEBUG_HIDDEN", debug_hidden,
                              2) != 0;
  ShowWindow(hwnd_, hide_debug_window ? SW_HIDE : SW_SHOWNORMAL);
